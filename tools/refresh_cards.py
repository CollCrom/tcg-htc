...
Usage:
    ...
    # or:
    python3 tools/refresh_cards.py
...
format expected by CardDatabase. This is data tooling, not engine code —
the engine just reads the resulting TSV.
"""
...
def fetch_and_convert(
    ...
    if output_path is None:
        output_path = Path(__file__).parent.parent / "data" / "cards.tsv"
