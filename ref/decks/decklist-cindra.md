...
- 2x Art of the Dragon: Fire (Red)
- 3x Blaze Headlong (Red)
- 3x Burning Blade Dance (Red)
- 3x Cut Through (Red)
- 2x Demonstrate Devotion (Red)
- 3x Display Loyalty (Red)
- 1x Enflame the Firebrand (Red)
- 2x Enlightened Strike (Red)
- 3x Fire Tenet: Strike First (Red)
- 3x Hot on Their Heels (Red)
- 3x Hunt the Hunter (Red)
- 3x Ignite (Red)
- 3x Lava Burst (Red)
- 1x Lava Vein Loyalty (Red)
...
- 2x Throw Dagger (Blue)

## Sideboard (14)
- 1x Claw of Vynserakai (Weapon)
- 1x Flamescale Furnace (Equipment - Chest)
- 1x Fate Foreseen (Red) — Defense Reaction
- 2x Hunt to the Ends of Rathe (Red) — Attack Action
- 3x Shelter from the Storm (Red) — Defense Reaction
- 3x Sink Below (Red) — Defense Reaction
- 3x Warmonger's Diplomacy (Blue) — Non-Attack Action
