...
from engine.rules.cost import can_pay_action_cost, can_pay_resource_cost
from engine.enums import ActionType, CardType, DecisionType, Keyword, SubType, SuperType, Zone
...
class ActionBuilder:
    ...
    def _get_playable_from_banish(state: GameState, player_index: int) -> list[CardInstance]:
        ...
        player = state.players[player_index]
        playable_ids = {bp.instance_id for bp in player.playable_from_banish}
