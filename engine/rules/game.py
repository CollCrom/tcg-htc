...
from engine.player.interface import PlayerInterface
from engine.state.combat_state import ChainLink
from engine.state.game_state import GameState
from engine.state.player_state import (
    BanishPlayability,
    EXPIRY_END_OF_TURN,
...
class Game:
    ...
    def _register_abilities(self) -> None:
        ...
        from engine.cards.abilities.ninja import register_ninja_abilities, register_ninja_cost_modifiers
        from engine.cards.abilities.equipment import register_equipment_abilities
        from engine.cards.abilities.agents import register_agent_abilities
        from engine.cards.abilities.tokens import register_token_abilities
    ...
    def _register_equipment_triggers(self) -> None:
        ...
        """
        from engine.cards.abilities.equipment import register_equipment_triggers
        for i, player in enumerate(self.state.players):
    ...
    def _play_card(self, player_index: int, card: CardInstance) -> None:
        ...
        from engine.enums import SuperType as _ST
    ...
    def _activate_weapon(self, player_index: int, weapon: CardInstance) -> None:
        ...
        from engine.cards.abilities.equipment import register_weapon_triggers
