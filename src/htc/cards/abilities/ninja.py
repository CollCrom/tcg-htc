...
#
# NOTE: Fabrary card_keywords lists Go Again, but the keyword parser
# correctly identifies it as conditional (preceded by "gets") and
# excludes it from the card's inherent keywords.
# ---------------------------------------------------------------------------
